...
#
../../plot_multiline.py $sharedoptions --paramlabel '$r_w$ = %.1f' --xlabel "Frequency (THz)" --ycol 'imag N' --ylim1 -0.5 --ylim2 2.5 \
   	--ylabel 'Refractive index $N_{\text{eff}}^{\prime\prime}$' --output ${PWD##*/}_ni.pdf

../../plot_multiline.py $sharedoptions --paramlabel '$r_w$ = %.1f' --xlabel "Frequency (THz)" --ycol 'real eps' --ylim1 -12 --ylim2 3  \
